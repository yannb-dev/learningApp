        ...
        <div className="mt-10">
          ...
          <div className="w-[70%] flex flex-col p-6 rounded-xl bg-aside text-justify mt-8">
            ...
            <p>
              ...
              importé, génère une roadmap d&apos;apprentissage personnalisée
              dans un fichier roadmap.json. Contraintes : - Adapte le rythme à
              ma disponibilité hebdomadaire - Commence par consolider les bases
              ...
              N&apos;ajoutes rien d&apos;autre. Format de roadmap souhaité dans
              un fichier roadmap.json
            </p>
          </div>
        </div>
      )}
